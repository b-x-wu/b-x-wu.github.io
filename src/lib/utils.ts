export type IconButtonProps =  { 'aria-label': string, src: string, 'data-tag'?: string };
...
export const updateIconButton = (dataTag: string, { 'aria-label': ariaLabel, src }: Partial<IconButtonProps>): void => {

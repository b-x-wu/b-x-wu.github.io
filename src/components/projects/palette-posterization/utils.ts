...
const COLOR_METRIC_TO_SOURCE: Record<ColorMetricType, string> = {
...
const COLOR_REDUCER_TO_SOURCE: Record<RenderedColorReducerType, string> = {
    [RenderedColorReducerType.PALETTE]: paletteColorReducerSource,
    [RenderedColorReducerType.AVERAGE]: averageColorReducerSource,
    [RenderedColorReducerType.PRESERVE_HUE]: preserveHueColorReducerSource,
    [RenderedColorReducerType.PRESERVE_SL]: preserveSlColorReducerSource,
    [RenderedColorReducerType.MIXBOX]: mixboxColorReducerSource,
};

 ...
 */
export const loadShader = (gl: WebGLContext, type: number, source: string) => {
...
export const initTexture = (gl: WebGLContext) => {
  ...
  gl.texImage2D(
    ...
    new Uint8Array([0, 0, 0, 0]), // source, a single clear pixel
  );
 ...
 * @param attributeLocation the location of the attribute (from gl.getAttribLocation(...))
 * @param num the number of data values per attribute value
 */

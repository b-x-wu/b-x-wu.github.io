...
//
//  Trimmed from the official shaders/mixbox.glsl: the mixbox_*
//  functions are unmodified; the MIXBOX_LUT macro and linear
//  colorspace branches were removed, and a reducer() wrapper added.
// ==========================================================
